...
/**
 * FileReader class reads the input file
 * Loads the calendar with preset events
 */
...
public class FileReader 
{
	...
	//FileReader constuctor
	public FileReader(String name)
	{
		fileName = name;
	}
	
	//Reads the file, breaks down the content, and loads into the Calender class
    public void fileReader(MyCalendar myCal) throws FileNotFoundException
    {
		...
		//While loop that reads and edits the events.txt file upon user input
